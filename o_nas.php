			...
			<p style="position: relative; top: -45px; left: 500px;">Aktualizováno 26. ledna 2019</p>
				...
				<h2>Kde se scházíme?</h2>
  				...
  				<h2>Kdo nás vede?</h2>
					...
					<h3>Rádcové</h3>
						<ul>
                            <li>Veronika Kokešová – Špunťa (Lasičky)</li>
                            <li>Adéla Vilímková – Matinel (Ještěrky)</li>
                            <li>Barbora Kobesová (Ještěrky)</li>
                            <li>Jan Jindáček - Rex (Lišáci)</li>
                            <li>Adam Kobes - Brzda (Káňata)</li>
						</ul>		
