	...
	<div id="hlavni">
		...
		<div class="obsah">				
			<h1>Přijímáme nové členy!</h1> 
				...
				<h2>Chceš:</h2>
				 	<ul style="font-weight: bold">
						...
						<li>zkusit si, jaké je to být kouzelnicí, rytířem, skřítkem, elfem  
							<span style="font-weight: normal">a to nejen v počítačové hře?</span></li>
				...
				<h2 id="prijem"> Přijímáme nové skauty – holky a kluky od 10 do 13 let!</h2>
					<h3>Přijď se podívat na některou schůzku!</h3>
						<h4>středa – 16:00 – 18:30</h4>
							<ul>
                                <li>Lasičky (holky 10 – 12 let)</li>
                                <li>Lišáci (kluci 10 - 14 let)</li>					 	
							</ul> 	
				 		<h4>čtvrtek – 16:00 - 18:30h</h4>
					 		<ul>
                                <li>Káňata (kluci 10 – 14 let) </li>
                                <li>Ještěrky (kluci 9 – 11 let) </li>
							</ul>
                                                
					 		<br>
					 		<p>V případě že je družina plně obsazena, přijímáme náhradníky - v případě, že
                                některé dítě ukončí činnost, budeme Vás kontaktovat.</p>
                                                        
					 		<p>Scházíme se vždy v 16 h na zastávce Husův park na Doubravce.</p>	
          ...
          <p>V letošním roce přešlo velké množství mladších dětí do starší věkové kategorie a náš oddíl je po dlouhé době schopen přijmout nové členy. Přijímáme kluky a holky ve věku 6 - 10 let (1. - 5. třída).</p>
            <h4>Schůzky budou takto:</h4>
                ...
                <h4>Kontakt pro nováčky</h4>	 
                    <ul>
                        <h4>Skauti a skautky:</h4>
                        <li>Michal Straka – Drak, mobil: 773 608 499, mail: michalstraka1236@gmail.com (vůdce oddílu)</li>
                        <h4>Vlčata a světlušky:</h4>
                        <li>Šárka Sedláčková - Syky, mobil: 605 472 772, mail: vlocka.info@gmail.com (vůdkyně vlčat a světlušek)</li>
                    </ul>
